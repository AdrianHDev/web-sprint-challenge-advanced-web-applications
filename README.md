...
A token is used to authenticate that you are the user you say you are.

2. What steps can you take in your web apps to keep your data secure?
Some steps you can take to keep your web apps secure is using SSL, and verifying you have set up your CORS policy correctly
